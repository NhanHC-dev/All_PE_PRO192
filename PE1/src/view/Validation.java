...
public class Validation {
    ...
    public static float getDouble(float minRange, float maxRange) {
        return getDouble(null, minRange, maxRange);
    }

    public static float getDouble(String msg) {
        return getDouble(msg, Float.MIN_VALUE, Float.MAX_VALUE);
    }

    public static float getDouble(String msg, float minRange, float maxRange) {
        if (minRange > maxRange) {
            float temp = minRange;
            minRange = maxRange;
            maxRange = temp;
    ...
    public static Date inputDate(String msg) {
        while (true) {
            try {
                ...
                Date date = checkValidDate(input);
                return date;
            } catch (Exception e) {
